...
import 'package:e_perpustakaan/app/components/bookDetails.dart';
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: SizedBox(height: MediaQuery.of(context).size.height * 0.74,child: SingleChildScrollView(scrollDirection: Axis.vertical,child: MyBookDetails(dataBookDetails: state!.state1!, dataUlasan: state.state2!,)))),
              Positioned(
                bottom: 10,
                child: Container(
